...
Cada arquivo deve conter um array JSON de itens com `id` único. Itens existentes são atualizados por `id`, novos itens são adicionados ao final e registros sem atualização são preservados.
